...
<!-- region:toc -->
- [1. 📝 Description](#1--description-21)
- [2. 💻 solutions.暴力解法](#2--solutions暴力解法-3)
- [3. 💻 solutions.快慢指针](#3--solutions快慢指针)
...
- **变量说明：**
  ...
  - `k` 是一个紧跟着 `i` 的辅助指针
- **流程说明：**
- ![](assets/2024-11-10-18-55-21.png)
...
- 提交记录：虽然能够通过一些示例，但 `nums[i]` 一旦出现负数或者大于 9 的数，这法子就行不通了。
  - ![](assets/2024-11-10-19-07-44.png)
