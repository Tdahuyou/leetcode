...
- [2. 💻 solutions.调用自带的 sort 函数](#2--solutions调用自带的-sort-函数)
- [3. 💻 solutions.冒泡排序](#3--solutions冒泡排序)
- [4. 💻 solutions.三路快速排序方法](#4--solutions三路快速排序方法)
- [5. 💻 solutions.基排序](#5--solutions基排序)
<!-- endregion:toc -->
